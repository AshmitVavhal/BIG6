...
class SemanticReasoningService:
    ...
    def analyze_vqa(
        ...
        """
        # Step 1: Run GeoChat for remote-sensing domain observations
        ...
        warning_text = (
            ...
            if (gemini_service.is_configured and model_label.startswith("GeoChat + Gemini")) else
        ...
        return {
            ...
            "confidence": 0.98 if gemini_service.is_configured else 0.95,
